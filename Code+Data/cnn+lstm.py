...
class CNNLSTM(nn.Module):
    def __init__(self, in_channels, out_channels, hidden_size, num_layers, output_size, batch_size, seq_length) -> None:
        ...
        self.lstm_per = nn.LSTM(input_size=11, hidden_size=hidden_size, num_layers=num_layers, batch_first=True)
...
output_size=1
split_ratio=0.9
moudle=CNNLSTM(input_size,out,hidden_size,num_layers,output_size,batch_size,seq_length).to('cuda:0')
